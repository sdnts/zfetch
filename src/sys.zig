...
const darwin = @import("./sys/darwin.zig");
...
pub const Sys = struct {
    ...
    pub fn writeNext(self_opaque: *anyopaque, allocator: Allocator, writer: Writer) !?void {
        _ = allocator;
        _ = writer;
        ...
        switch (@intToEnum(SysKind, self.lines_written)) {
            ...
            .RAM => {
                ...
                //         break :blk darwin.sysctl(allocator, usize, mib[0..]);
                //     }
                //
